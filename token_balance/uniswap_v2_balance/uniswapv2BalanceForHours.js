...
export async function getUniswapV2BalanceByHour(startTimestamp=0,endTimestamp=Date.now()/1000){
    try{
       
       
        return fillBigArrayForHours(reformToBigArrayForHours( await getUniswapV2BalanceByHoursFromGraph()),startTimestamp,endTimestamp);
    }
    catch(err)
    {
        console.log(err)
...
export async function getUniswapV2BalanceBy4Hour(startTimestamp=0,endTimestamp=Date.now()/1000){
    try{

        return fillBigArrayFor4Hours(reformToBigArrayForHours( await getUniswapV2BalanceByHoursFromGraph()),startTimestamp,endTimestamp);
    }
    catch(err)
    {
        console.log(err)
...
async function getUniswapV2BalanceByHoursFromGraph(){
    try{
