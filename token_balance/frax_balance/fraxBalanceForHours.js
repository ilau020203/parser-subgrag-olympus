...
export async function getFRAXBalanceByHour(startTimestamp=0,endTimestamp=Date.now()/1000){
    try{
       
       
        return fillBigArrayForHours(reformToBigArrayForHours( await getFRAXBalanceByHoursFromGraph()),startTimestamp,endTimestamp);
    }
    catch(err)
    {
        console.log(err)
...
export async function getFRAXBalanceBy4Hour(startTimestamp=0,endTimestamp=Date.now()/1000){
    try{

        return fillBigArrayFor4Hours(reformToBigArrayForHours( await getFRAXBalanceByHoursFromGraph()),startTimestamp,endTimestamp);
    }
    catch(err)
    {
        console.log(err)
...
async function getFRAXBalanceByHoursFromGraph(){
    try{
